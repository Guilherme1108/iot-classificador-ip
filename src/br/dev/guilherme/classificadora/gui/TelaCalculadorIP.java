...
public class TelaCalculadorIP {
    ...
    public void criarTelaCalculadoraIP() {
		...
		// criando e escolhendo onde será o local de escrever o endereço
        enderecoIpCIDR = new JTextField();
        enderecoIpCIDR.setBounds(40, 55, 370, 30);
        
     // criando e personalizando o botão de calcular
        buttonCalcular = new JButton();
        buttonCalcular.setText("Calcular"); // mensagem do botão
        buttonCalcular.setBounds(150, 100, 140, 40); // lugar onde ele vai estar
        buttonCalcular.setForeground(new Color(255, 255, 255)); // cor do texto do botão
		...
		// adicionando ação no botão calcular quando ele for clicado
